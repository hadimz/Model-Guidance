...
#SBATCH --cpus-per-task=8 # change this parameter to 2,4,6,... to see the effect on performance
#SBATCH --gpus=h100:1 
#SBATCH --mem=64G
#SBATCH --time=2:00:00
